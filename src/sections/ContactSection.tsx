...
const CONTACT_CHANNELS = [
  {
    label: 'EMAIL',
    detail: 'gorwadepranav4@gmail.com',
    action: 'SEND MESSAGE',
    href: 'mailto:gorwadepranav4@gmail.com',
  },
  {
    label: 'LINKEDIN',
    detail: 'linkedin.com/in/pranav-gorwade',
    action: 'OPEN PROFILE',
    href: 'https://www.linkedin.com/in/pranav-gorwade/',
  },
  {
    label: 'GITHUB',
    detail: 'github.com/Pranavgorwade',
    action: 'VIEW GITHUB',
    ...
    >
      <div className="signal-layout">
        ...
        <div className="signal-action-zone motion-reveal" data-motion-reveal="fade-up">
          <a className="signal-primary-cta" href="mailto:gorwadepranav4@gmail.com">
            <span>START A CONVERSATION</span>
            <span aria-hidden="true">↗</span>
          </a>
          <div className="signal-ai-hook" aria-label="Pranav AI visual hook">
            <span>CURIOUS?</span>
            <span>ASK PRANAV AI ↗</span>
          </div>
        </div>

        <div className="signal-signature motion-reveal" data-motion-reveal="fade-up">
          <strong>PRANAV GORWADE</strong>
          <span>CSE · FULL-STACK DEVELOPMENT · SOFTWARE ENGINEERING</span>
