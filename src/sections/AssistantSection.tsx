...
const SAMPLE_MESSAGES = [
  {
    ...
    text: 'Hey! Ask me anything about Pranav — his projects, skills, experience, or how to get in touch.',
  },
  {
    id: 'visitor-1',
  ...
  return (
    ...
    >
      ...
      <div className="motion-reveal" data-motion-reveal="fade-up" style={{ textAlign: 'center', marginBottom: 'var(--space-12)' }}>
        ...
        >
          A personal AI assistant trained on Pranav&apos;s portfolio, projects,
