...
const FIELD_DETAILS = [
  ...
  { label: 'MODE', value: 'NOT PROVIDED' },
  { label: 'DURATION', value: 'JAN - APR 2025' },
];

const FIELD_TIMELINE = ['ACADEMICS', 'PROJECTS', 'SPARK IT', 'NEXT'];
      ...
      <div className="field-layout page-container">
        <div className="field-intro">
          ...
          <div className="field-timeline motion-reveal" data-motion-reveal="fade-up" aria-label="Professional transition timeline">
            {FIELD_TIMELINE.map((item, index) => (
              <div key={item} className={`field-timeline-step${item === 'SPARK IT' ? ' is-active' : ''}`}>
        ...
        <div className="field-briefing motion-reveal" data-motion-reveal="fade-up">
          ...
          <div className="field-briefing-header">
            ...
            <span className="field-briefing-year">2025</span>
          </div>

          <div className="field-briefing-title">
            <h3><CinematicSplitText lines={['SPARK IT DEVELOPERS']} splitType="words" /></h3>
            <p>MERN STACK INTERN</p>
          </div>

          <div className="field-details" aria-label="MERN Stack internship details">
          ...
          <p className="field-transition-statement">
            Completed a practical MERN Stack internship focused on full-stack development, responsive interfaces, backend services, testing, debugging, and deployment.
          </p>
        </div>
      </div>
