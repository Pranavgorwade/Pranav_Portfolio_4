      ...
      <div className="stage-2-editorial-grid">
        <div className="stage-2-bio-column">
          ...
          <p className="about-bio-paragraph motion-reveal" data-motion-reveal="fade-up">
            I&apos;m a Computer Science student focused on full-stack web development,
            building responsive interfaces and reliable backend services through practical projects.
          </p>
        ...
        <aside className="about-secondary-stack motion-reveal" data-motion-reveal="fade-up">
          <div className="about-info-block">
            ...
            <div className="about-info-body">
              <p>K.L.E. College of Engineering</p>
              <p>&amp; Technology</p>
              <p>Bachelor of Engineering</p>
              <p>Computer Science &amp; Engineering</p>
              <p>2025 — 2028</p>
              <p className="about-info-muted">Diploma: K.L.E Society&apos;s C.B Kore Polytechnic, 2022 — 2025</p>
            </div>
          </div>
