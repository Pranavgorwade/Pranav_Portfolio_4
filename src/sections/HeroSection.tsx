  ...
  return (
    <div className={`hero-stage-layout page-container ${isReady ? 'hero-is-ready' : ''}`}>
      <div className="hero-stage-content">
        ...
        <h1 className="hero-headline" aria-label="Pranav Gorwade">
          <CinematicSplitText lines={['PRANAV', 'GORWADE']} className="hero-cinematic-name" />
        </h1>

        <p className="hero-discipline">CSE • FULL-STACK DEVELOPMENT • SOFTWARE ENGINEERING</p>
        <p className="hero-tagline">Turning ideas into impact.</p>
        <p className="hero-personality">“Hi, I&apos;m Pranav — I build practical web experiences and keep learning by doing.”</p>
