...
const RESUME_URL = '/resume/Pranav_gorwade_resume.pdf';
        ...
        <div className="resume-cta-content">
          ...
          <div className="resume-cta-actions">
            <a
              ...
              aria-label="View Pranav Gorwade Resume PDF in a new tab"
            >
            ...
            <a
              href={RESUME_URL}
              download="Pranav_gorwade_resume.pdf"
              className="btn btn-secondary btn-md resume-btn"
              aria-label="Download Pranav Gorwade Resume PDF"
            >
              <svg
                width="14"
                height="14"
