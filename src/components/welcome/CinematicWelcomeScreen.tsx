...
export const CinematicWelcomeScreen: React.FC<CinematicWelcomeScreenProps> = ({ onEnter }) => {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label="Welcome to Pranav's Cinematic Universe"
    >
      ...
      <div className={`welcome-content-card${isExiting ? ' is-dissolving' : ''}`}>
        ...
        <span className="welcome-eyebrow">PRANAV GORWADE // DEV PORTFOLIO</span>
        ...
        <p className="welcome-meta-note">
          ◆ Designed for the full-screen experience • Desktop recommended
        </p>
        ...
        <div className="welcome-action-wrapper">
          <button
            ...
            autoFocus
            aria-label={isAutoplayBlocked ? 'Enter Pranav\'s Cinematic Universe with sound' : 'Enter Pranav\'s Cinematic Universe'}
          >
            ...
            <span className="btn-text">
              {isRevealing
                ...
                : isAutoplayBlocked
                ? 'ENTER WITH SOUND'
                : 'ENTER PRANAV\'S CINEMATIC UNIVERSE'}
            </span>
